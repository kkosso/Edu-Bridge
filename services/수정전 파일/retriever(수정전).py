...
TOP_K_COUNTRIES = 5        # 최종 반환할 국가 수
ALPHA = 0.6                # 청크 점수 집계: max 가중치
BETA = 0.4                 # 청크 점수 집계: avg 가중치 (alpha + beta = 1)
GAMMA = 0.3                # philosophy_summary 1차 가중치 비중
...
def main():
    ...
    for query in test_queries:
        result = retriever.search(query, top_k_countries=5)
